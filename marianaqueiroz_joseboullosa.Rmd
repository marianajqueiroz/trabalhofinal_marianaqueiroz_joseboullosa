...
author: "mariana_queiroz_josé_boullosa"
...
```{r, echo=TRUE}
banco_casos_completos <- banco_mjq %>% 
  filter(complete.cases(.))

banco_casos_completos <- banco_casos_completos %>% 
  rename(cod_pac=BancoRelacionado2017_final.codpacnovo,
         sim=BancoRelacionado2017_final.sim,
         causa_obito=BancoRelacionado2017_final.causabas_sim,
         ano_diagnostico=BancoRelacionado2017_final.anodiag_texto,
         hierarf=BancoRelacionado2017_final.hierarf,
         idade=BancoRelacionado2017_final.idade,
         uf=BancoRelacionado2017_final.ufres,
         escolaridade=BancoRelacionado2017_final.escolar,
         raca=BancoRelacionado2017_final.raca,
         dt_diag=BancoRelacionado2017_final.dtdiag,
         sexo=BancoRelacionado2017_final.sexo,
         origem=BancoRelacionado2017_final.origem,
         dt_nasc=BancoRelacionado2017_final.dtnasc,
         dt_ult_atu_siscel=BancoRelacionado2017_final.data_ult_atu_siscel,
         copias_cv=BancoRelacionado2017_final.copias_cv,
         dt_coleta_cv=BancoRelacionado2017_final.dt_coleta_cv,
         cd4_menor=BancoRelacionado2017_final.cd4menor,
         cd4_maior=BancoRelacionado2017_final.cd4maior,
         grupo_cd4_menor=BancoRelacionado2017_final.grupo_cd4_cd4menor,
         grupo_cd4_maior=BancoRelacionado2017_final.grupo_cd4_cd4maior,
         tto=BancoRelacionado2017_final.disp,
         dt_ult_disp=BancoRelacionado2017_final.dt_dipensa_disp,
         hiv_aids=V24,
         ctrl_geral=V25,
         criterio=V26
          )
